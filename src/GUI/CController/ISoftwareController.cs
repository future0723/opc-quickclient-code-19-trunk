...
namespace GUI.CController
{
    public interface ISoftwareController
    {
        ...
        void CloseServerTabView(IServerView werverView);

        List<string[]> SearchOpcServers(string machineName);

        IServerView ConnectToOpcServer(string machineName, string werverID);
